...
/* TODO_queue todo_node and include  */
...
/*typedef struct _punishment {
    struct list_head todo_list;
    unsigned long punish_time;
    task_t *p;
} punishment;

extern list_head punish_head;*/
...
{									\
    ...
    journal_info:	NULL,						\
    firstTodo:      LIST_HEAD_INIT(tsk.firstTodo),           \
    punish_timer:   NULL,    \
}
